...
delete_text_from_file '/smartctl 7.4/d' "$logfile"
delete_text_from_file '/Copyright/d' "$logfile"
delete_text_from_file '/=== START OF READ/d' "$logfile"
delete_text_from_file '/SMART Attributes Data/d' "$logfile"
delete_text_from_file '/Vendor Specific SMART/d' "$logfile"
delete_text_from_file '/SMART Error Log Version/d' "$logfile"
